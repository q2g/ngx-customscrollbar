...
import { AfterViewInit, Component, ElementRef, Host, Inject, NgZone, OnDestroy, Renderer2, ViewChild, OnInit, Input, HostBinding, ViewEncapsulation } from '@angular/core';
...
@Component({
    selector: 'q2g-scroll-bar',
    templateUrl: 'scrollbar.component.html',
    styleUrls: ['./scrollbar.component.scss']
})
export class ScrollbarsComponent implements AfterViewInit, OnDestroy, OnInit {
     ...
     *
     * @private
     * @param {DomHelper.IElementMeasure} measure
     * @memberof ScrollbarsComponent
     */
